...
bool perspective::initialize(const data::frame& cur_frm, const std::vector<int>& ref_matches_with_cur) {
    ...
    if (0.5 < rel_score_H && homography_solver.solution_is_valid()) { // 0.40
        ...
        std::cout << "trying to reconstruct with H" << std::endl;
        ...
        std::cout << "trying to reconstruct with F" << std::endl;
