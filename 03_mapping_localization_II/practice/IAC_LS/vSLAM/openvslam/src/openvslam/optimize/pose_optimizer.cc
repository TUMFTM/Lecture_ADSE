...
unsigned int pose_optimizer::optimize(data::frame& frm) const {
    ...
    // 2. Convert the frame to g2o vertex and set the frame to the optimizer
    ...
    // 3. Connect landmark vertexes with re-projection edges
    ...
    // Chi-square value of 5% significance level
    ...
    for (unsigned int idx = 0; idx < num_keypts; ++idx) {
        ...
        // Connect the frame vertex with the re-projection edge
