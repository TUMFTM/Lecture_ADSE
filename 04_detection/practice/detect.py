...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--image_folder",
        type=str,
        default="data/kitti/images/test",
    ...
    parser.add_argument(
        "--weights_path",
        type=str,
        default="weights/yolov3-kitti-tiny.pth",
        help="path to weights file",
    )
    parser.add_argument(
        "--class_path",
        type=str,
        default="data/kitti/classes.names",
    ...
    dataloader = DataLoader(
        ImageFolder(
            opt.image_folder,
            transform=transforms.Compose([DEFAULT_TRANSFORMS, Resize(opt.img_size)]),
        ),
